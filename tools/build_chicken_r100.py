...
def build()->dict:
 ...
 if PECK_MARKER not in peck_patch:raise RuntimeError('peck adapter marker missing')
...
def write_review()->None:
 ...
 items=[('站立','R100_IDLE.png'),('观察','R100_LOOK.png'),('啄地','R100_PECK.png'),('啄地侧面接触','R100_PECK_SIDE_CONTACT.png'),('行走','R100_WALK.png'),('步进转向','R100_TURN.png'),('短跑','R100_RUN.png'),('翼平衡','R100_WING_BALANCE.png'),('停止','R100_STOP.png')]
