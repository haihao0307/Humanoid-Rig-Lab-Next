...
def write_params()->None:
 write_json(PARAMS,{
  ...
  'runtime':{'controller':'runtime/chicken_phase1_npc_controller.mjs','articulated_skin':'runtime/chicken_phase1_articulated_skin.mjs','manual_step':'tools/chicken_r100_manual_step_patch.js','root_motion_scale':0.42,'fixed_bone_lengths':True,'non_root_scale_forbidden':True,'contact_diagnostics':['bill_ground_error','left_foot_ground_error','right_foot_ground_error']},
