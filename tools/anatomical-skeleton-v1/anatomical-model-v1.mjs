...
function createFemurBoneParameter(segment, variantSpec) {
  ...
  const generatorParameters = {
    ...
    greaterTrochanterSize: 0.020, lesserTrochanterSize: 0.0105, distalCondyleWidth: 0.06972, distalCondyleDepth: 0.06068,
    greaterTrochanterTipHeight: 0.0060, greaterTrochanterAnteriorCrest: 0.0030, greaterTrochanterPosteriorCrest: 0.0035,
    ...
    medialCondyleScale: 1.08, lateralCondyleScale: 1.00,
    medialCondylePosteriorLength: 0.0080, lateralCondylePosteriorLength: 0.0090,
    medialCondyleDistalOffset: -0.0060, lateralCondyleDistalOffset: -0.0045,
    medialEpicondyleSize: 0.0050, lateralEpicondyleSize: 0.0045, adductorTubercleSize: 0.0038,
    intercondylarFossaWidth: 0.020, intercondylarFossaDepth: 0.0110,
    patellarSurfaceDepth: 0.0008, medialTrochlearRidgeHeight: 0.0060,
    lateralTrochlearRidgeHeight: 0.0075, patellarGrooveDepth: 0.0075,
  };
