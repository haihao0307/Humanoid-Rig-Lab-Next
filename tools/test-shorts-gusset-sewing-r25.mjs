...
const files=['ShortsPattern.js','ShortsPlacementR2.js','ShortsStitchDofs.js','ShortsContinuousContact.js','ShortsSurfaceContact.js','ShortsTriangleBodyContact.js','ShortsTubeFormationR2.js','ShortsDualTubeR2.js','ShortsRiseAssemblyR2.js','ShortsGussetAssemblyR2.js','ShortsGussetSewingR2.js','ShortsCloth.js'];
const context=vm.createContext({Float32Array,Float64Array,Uint32Array,performance});
vm.runInContext(files.map(file=>fs.readFileSync(new URL('../clothing/'+file,import.meta.url),'utf8')).join('\n')+';globalThis.Pattern=createShortsPattern;globalThis.Cloth=ShortsCloth;globalThis.State=createShortsGussetSewingStateR25;globalThis.Rise=completeShortsRiseR24;globalThis.Begin=beginShortsGussetSewingR25;globalThis.Advance=advanceShortsGussetSewingR25;',context);
const {Pattern,Cloth,State,Rise,Begin,Advance}=context;
