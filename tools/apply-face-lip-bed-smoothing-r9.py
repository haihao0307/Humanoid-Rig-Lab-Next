...
addition = "\n check(source.includes('const lipBedSurface=')&&source.includes('smooth+(surface(x,y)-smooth)*attach')&&source.includes('lipBedSurface(x,y,t)'),'lip free-edge geometry uses a bounded low-pass and returns exactly to the source skin at attachment');"
