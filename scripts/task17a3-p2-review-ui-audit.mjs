...
const baselineCommit = 'df892641400c63cf146ba9a4feaeda79a033ddf8';
...
const receipt = {
  ...
  mediaStatus: 'pending_user_capture',
  captureCommand: 'node scripts/capture-task17a3-p2-finalpose.mjs',
};

mkdirSync(dirname(outputPath), { recursive: true });
writeFileSync(outputPath, `${JSON.stringify(receipt, null, 2)}\n`);
console.log(`PASS P2 review UI file audit: ${Object.keys(cameraChecks).length} camera checks; ${poseSynchronizationChecks.length} pose states; ${protectedFiles.length} frozen files unchanged.`);
