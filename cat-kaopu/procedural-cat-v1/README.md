...
P1.4 已经让实测骨链进入连续身体载体，但固定六视图仍显示低伏预备姿态、圆管四肢、突出的眼球和水平警觉尾。P1.5 在不改变实测骨段长度的前提下完成：

- 提高身体内部的肩、髋支撑点，减少不必要的深屈曲。
- 让前掌接近肩部垂线，后掌只适度位于髋前。
- 提高飞节并收敛膝—飞节—跖部的中性折线。
- 使用椭圆渐变肢体载体替代圆形管状肢体。
- 分离肘、腕、膝和飞节轮廓，同时禁止关节辅助球团。
- 收紧头颈、眼球、耳廓和足掌负重轮廓。
- 尾巴采用放松下垂候选，而不是水平警觉线。

P1.5 仍是稳定拓扑之前的作者态候选。六视图视觉通过前，不进入 Surface Carrier、蒙皮或动作。
