...
assert.equal(parsed.json.nodes.length, 89);
assert.ok(parsed.json.nodes.some((node) => node.name === 'leftIndexProximal'));
assert.ok(parsed.json.nodes.some((node) => node.name === 'leftHandIK'));
