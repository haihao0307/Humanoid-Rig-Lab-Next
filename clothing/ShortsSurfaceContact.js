...
class ShortsSurfaceContact {
 constructor(particles,triangleRecords,body,{clearanceM=.0025,toleranceM=.001,includeVertices=true,includeOnlyIncidentVertices=false,dofs=null}={}){
  ...
  if(!Number.isFinite(clearanceM)||clearanceM<0||!Number.isFinite(toleranceM)||toleranceM<0||typeof includeVertices!=='boolean'||typeof includeOnlyIncidentVertices!=='boolean')throw Error('Invalid surface contact options');
