...
function auditShortsLeftTubeR23(simulation,state,baseReport={...state.report},options={}){
  ...
  return {...baseReport,stitchJoinToleranceM:simulation.options.stitchJoinToleranceM,valid,sourceIdentityPreserved,totalMassPreserved,closedSeams:closed,cuff:{pointCount:cuff.length,projectedAreaM2:area,closureGapM,positiveArea:area>1e-4},materialAtCheckpoint:material,
