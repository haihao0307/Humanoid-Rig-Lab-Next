...
function initialCharacterPreset(){return validateCharacterPreset(window.__NPC_DEFINITION__?.character||window.__CHARACTER_PRESET__||{label:'立体男性参考',appearance:{face:{identity:{shape:FACE_SCULPTED_MALE_SHAPE}},skin:{baseColor:'#c7a18d',roughness:.60,oil:.15,redness:0}}});}
