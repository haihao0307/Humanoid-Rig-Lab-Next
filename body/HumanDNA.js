...
function installHumanDNA(lab){
 ...
 const describe=()=>({objectId:lab.human.characterPreset.id,objectType:'LivingObjectDNA',kind:'authored digital character',generatorRevision:HUMAN_GENERATOR_REVISION,status:'Candidate'});
 const exportDocument=()=>({
  ...
  provenance:{generatorRevision:HUMAN_GENERATOR_REVISION,sourceLocks:copy(HUMAN_DNA_CONTRACT.sourceLocks),semanticFreezeCommit:HUMAN_DNA_CONTRACT.semanticFreezeCommit,parameterOrigin:'authored character definition'},
