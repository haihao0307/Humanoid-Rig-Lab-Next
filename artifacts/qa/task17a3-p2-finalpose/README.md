# Task 17A.3 P2 Evidence

Committed file/numerical evidence:

- `asset-identity.json`: frozen GLB SHA256, geometry/index hashes, and asset counts.
- `module-map.json`: all 24 read-only display-derived module records.
- `six-scene-numeric-summary.json`: the required numerical fields for six fixtures.
