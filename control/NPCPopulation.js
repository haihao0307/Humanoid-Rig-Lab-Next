 ...
 context(id,definition,human,agent,compact=null){
  ...
  actor.face={uniforms:()=>{
   ...
   if(residentFacePose!==pose){
    ...
    residentFaceUniforms={offsets,proportions:resolved.proportions,muscles,eyelids,lipOpen:resolved.lipOpen,jawOpen:resolved.jawOpen,enabled:resolved.lipOpen>0||resolved.jawOpen>0||resolved.proportions.some(v=>v!==0)||[offsets,muscles,eyelids].some(values=>values.some(v=>v!==0))?1:0,heatmap:0,selected:0};residentFacePose=pose;
   }
